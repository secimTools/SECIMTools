...
coefficient_variation_flags.py \
    ...
    -d  $INPUT_DIR/ST000006_design_2_test_CV.tsv \
    -id Retention_Index \
    -g  White_wine_type_and_source \
    -f  "$OUTPUT_DIR/ST000006_coefficient_variation_flags_with_group_figure_test.pdf" \
    -o  "$OUTPUT_DIR/ST000006_coefficient_variation_flags_with_group_flag_test.tsv"
