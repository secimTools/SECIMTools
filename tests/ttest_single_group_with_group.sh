...
ttest_single_group.py \
    ...
    -mu 0 \
    -s  "$OUTPUT_DIR/ST000006_ttest_single_group_with_group_summary.tsv" \
    -f  "$OUTPUT_DIR/ST000006_ttest_single_group_with_group_flags.tsv" \
    -v  "$OUTPUT_DIR/ST000006_ttest_single_group_with_group_volcano.pdf"
