...
def flagSignificant(fullRes):
    ...
    # Flagging lpval > 0.05
    df_flags["flag_significant_0.05_on"] = np.where(np.abs(fullRes["-log10_p-value_"]) > -np.log10(0.05),str(0),str(1));fullRes
    df_flags["flag_significant_0.01_on"] = np.where(np.abs(fullRes["-log10_p-value_"]) > -np.log10(0.01),str(0),str(1));fullRes
    df_flags["flag_significant_0.1_on"]  = np.where(np.abs(fullRes["-log10_p-value_"]) > -np.log10(0.1), str(0),str(1));fullRes
